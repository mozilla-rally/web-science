...
// Classifier state
let name, featureLabels, coefficients, intercept, tokenizationParams, idfVector = null;
...
onmessage = event => {
    ...
    if (pageData.type === "init") {    
        ...
        intercept = parseFloat(pageData.args.class0_intercept)
        ...
        sendMessageToCaller("pol-page-classifier", classify(pageData.payload), pageData.payload.url);
    }
}
...
function classify(pageContent) {
    ...
    var prob = 0.;
    for (var i = 0, il = coefficients.length; i < il; i++) {
