...
(function () {
    ...
    const pageTransition = function() {
        ...
        browser.runtime.onMessage.addListener(message => {
            ...
            handleBackgroundScriptUpdate(message);
        });
        ...
        const handleBackgroundScriptUpdate = function({
            ...
            // TODO: add support for caching history API transition data, since it might arrive before
            // the pageVisitStart event fires
